...
export default function About_us() {
    ...
    return (
        <div >
            <div className="textbox-normal" style={{height:'80vh', width:'95%', backgroundColor:'white', 
                color:'#4e37af', borderRadius:'20px', marginTop:'2.5%', flexDirection:"column", marginLeft:"auto",
